...
/*  HARDWARE PARAMS */
float motor_steps_revolution = 200; //NEMA17 ticks 1,8º per step, 200 steps per revolution
float thread_ratio = 1.25; //a normal threaded rod (not helix) is about 1,25mm linear per revolution
int target_position_mm = 50; //this our final position is in mm, depends on how long your screw is
